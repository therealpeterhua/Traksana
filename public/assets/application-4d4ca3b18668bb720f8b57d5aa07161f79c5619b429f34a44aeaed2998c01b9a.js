...
(function() { this.JST || (this.JST = {}); this.JST["centerpiece/project_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3 class="project-codename">\n  ',  project.escape('code_name') ,'\n</h3>\n\n<div class="tasks-index-container">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["centerpiece/tasks_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="task-filter">\n  <!-- PH** Add a filter here later -->\n</div>\n\n<ul class="task-items">\n\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["centerpiece/tasks_index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<strong class=\'task-completion\'>\n  <div class="completion-icon" data-task-id="',  task.id ,'">\n  </div>\n</strong>\n\n<strong class=\'task-assignment\'>\n  <div class="assignment-icon" data-task-id="',  task.id ,'">☻</div>\n</strong>\n\n<form class="task-form">\n  <input class="task-title-input"\n         type="text" name="task[title]"\n         value="',  task.escape('title') ,'"\n         data-task-id="',  task.id ,'">\n</form>\n\n<strong class=\'task-deletion\'>\n  <div class="deletion-icon" data-task-id="',  task.id ,'">✘</div>\n</strong>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["feature/task_details"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class="task-title">\n  <textarea id="feature-task-title" name="task[title]">',  task.escape('title') ,'</textarea>\n</form>\n\n<form class="task-description" action="index.html" method="post">\n  <textarea id="feature-task-description" name="task[description]">',  task.escape('description') ,'</textarea>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["feature/task_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p class="task-details-container">\n</p>\n\n<ul class="task-comments-index-container">\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["landing_page/team_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<button class="reveal-form">Add New Team</button>\n\n<form class="new-team hidden">\n  <label for="team-name"></label>\n  <input id="team-name"\n         type="text"\n         name="team[moniker]"\n         value="',  team.escape('moniker') ,'">\n  <button class="submit-form">Submit</button>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["landing_page/teams_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="teams-index-title">Select Workspace</div>\n<div class="teams-index-list ">\n  <div class="teams-index-list-style group">\n    <ul class="teams-index-items group">\n    </ul>\n  </div>\n</div>\n\n<div class="new-team">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["landing_page/teams_index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="#/teams/',  team.id ,'"> ',  team.escape('moniker') ,' </a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["master/master"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="modal-cover hidden"></div>\n<div class="modal hidden"></div>\n\n<section class="sidebar master">\n</section>\n\n<div class="primary-sections">\n\n  <section class="navbar master">\n  </section>\n\n  <section class="titlebar master">\n  </section>\n\n  <div class="main-container master group">\n\n    <section class="centerpiece master hidden">\n    </section>\n\n    <section class="feature master hidden">\n    </section>\n\n  </div>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["modals/task_assignment/assigned_user_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  user.escape('name') ,'\n<strong class=\'delete-user-assignment\' data-user-id="',  user.id ,'">✖</strong>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["modals/task_assignment/assignment"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  task.escape('title') ,'\n\nCurrently assigned\n<ul class="current-assigned-user-items">\n\n</ul>\n\nAssign other team members\n<div class="new-assigned-users">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["modals/task_assignment/assignment_new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<input class="new-assignments-selector">\n\n<div class="new-assignments-container">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["modals/task_assignment/assignment_new_list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  users.each( function(user) { ; __p.push('\n  <li class="new-assigned-user-item" data-user-id="',  user.id ,'">\n    <div class="user-name">\n      ',  user.escape('name') ,'\n    </div>\n\n    <div class="user-email">\n      ',  user.escape('email') ,'\n    </div>\n  </li>\n');  }) ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["navbar/navbar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="tasks-teams-container">\n  <li class="team-selection">\n    SELECT TEAM\n    <div class="team-select-container"></div>\n  </li>\n  <li class="my-tasks">MY TASKS</li>\n  <li class="my-projects">MY PROJECTS</li>\n</ul>\n\n<input class="search-box">\n\n<div class="user-container">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["navbar/teams/team_select"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="team-select-items hidder">\n\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["navbar/teams/team_select_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  team.escape('moniker') ,'\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["navbar/user_corner"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="user-container-items">\n  <li class="sign-out">\n    <button class="sign-out">Sign out</button>\n  </li>\n  <li class="user-name">\n    <div class="user-name-display">',  currentUser.escape('email') ,'</div>\n  </li>\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sidebar/projects/project_new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<button class="reveal-form">×</button>\n\n<form class="new-project hidden">\n  <input type="text"\n         name="project[code_name]"\n         value="',  project.escape('code_name') ,'">\n\n  <button>Submit</button>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sidebar/projects/projects_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="project-items">\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sidebar/projects/projects_index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  project.escape('code_name') ,'\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sidebar/sidebar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="app-sidebar-header">\n  <h1 class="app-title">traksana</h1>\n  <div class="symbol">፠</div>\n</div>\n\n<div class="sidebar-body">\n  <h4 class="sidebar-title team">\n    ',  team.escape('moniker').toUpperCase() ,'\n  </h4>\n\n  <div class="members-index">\n  </div>\n\n  <h4 class="sidebar-title projects group">\n    PROJECTS\n    <div class="new-project">\n\n    </div>\n  </h4>\n\n  <div class="projects-index">\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sidebar/team/team_member_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="team-member-items">\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sidebar/team/team_member_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if ( member.escape('name') ) { ; __p.push('\n  ',  member.escape('name') ,'\n');  } else { ; __p.push('\n  ',  member.escape('email') ,'\n');  } ; __p.push('\n\n\n<!-- PH** if u really wanna just do name, then only have that -->\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["titlebar/titlebar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (project) { ; __p.push('\n  <h3 class="project-codename">\n    ',  project.escape('code_name') ,'\n  </h3>\n  <h4 class="project-subheading">\n    ',  currTeamMoniker ,'\n  </h4>\n');  } else { ; __p.push('\n  <h3 class="project-codename">\n    ',  Trak.currentUser.escape('name') ,'\'s ',  currTeamMoniker ,' Tasks\n  </h3>\n  <h4 class="project-subheading">\n    All current team tasks assigned to you\n  </h4>\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
